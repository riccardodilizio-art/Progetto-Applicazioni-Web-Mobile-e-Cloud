...
export const services: Service[] = [
    {
        ...
        icon: (<path strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" d="M3 17.25V21h18v-3.75M3 17.25c1.5 1 3 1.5 4.5 1.5s3-.5 4.5-1.5c1.5 1 3 1.5 4.5 1.5s3-.5 4.5-1.5M12 3v9m-3-3l3 3 3-3" />),
    },
    {
        title: 'Ristorante Gourmet',
        description: 'Cucina marchigiana e piatti internazionali preparati dal nostro chef stellato.',
        icon: (<path strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8V6m0 8v2m8-4a8 8 0 11-16 0 8 8 0 0116 0z" />),
    },
    {
        title: 'Spa & Benessere',
    ...
    },
    {
        ...
        icon: (<path strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" d="M12 3v1m0 16v1m8.66-13.66l-.71.71M4.05 19.95l-.71.71M21 12h-1M4 12H3m16.95 7.95l-.71-.71M4.76 4.76l-.71-.71M16 12a4 4 0 11-8 0 4 4 0 018 0z" />),
    },
]