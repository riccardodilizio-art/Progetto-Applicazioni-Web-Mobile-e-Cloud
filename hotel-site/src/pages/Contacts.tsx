            ...
            <div className="relative z-10 flex flex-col items-center px-4 pt-16 pb-12">
                ...
                >
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
                        ...
                        <div>
                            <h2 className="text-lg font-bold text-[#6B4828] mb-5">
                                Informazioni
                            </h2>
                            ...
                            <div className="space-y-4 text-sm text-gray-700">
                                ...
                                <div className="flex items-start gap-3">
                                    <svg className="w-5 h-5 text-[#6B4828] mt-0.5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
