...
export default function Contacts() {
    ...
    return (
        <div
            ...
            style={{
                backgroundImage:
                    // TODO: L'immagine deve essere inserita qua
            }}
        >
                        ...
                        <div>
                            ...
                            <div className="space-y-4 text-sm text-gray-700">
                                ...
                                <div className="flex items-start gap-3">
                                    <svg
                                        className="w-5 h-5 text-[#1a2e4a] mt-0.5 shrink-0"
                                ...
                                <div className="flex items-start gap-3">
                                    ...
                                    <div>
                                        ...
                                        <p>Check in dalle 08:00 alle 22:00</p>
