...
import type { RoomReservationAdmin } from '../../../types/Reservation'
...
export default function RoomReservationTable({ reservations, onDelete }: Props) {
...
function Th({ children, align = 'left' }: { children: React.ReactNode; align?: 'left' | 'right' }) {
    return (
        <th
            className={`text-${align} text-xs font-semibold text-[#9A6840] uppercase tracking-wider px-6 py-3`}
        >
            {children}
        </th>
    )
