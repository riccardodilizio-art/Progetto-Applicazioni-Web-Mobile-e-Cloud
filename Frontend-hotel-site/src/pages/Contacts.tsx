        ...
        >
            ...
            <div className="relative z-10 flex flex-col items-center px-4 pt-16 pb-12">
                ...
                <div className="text-center mb-8">
                    <h1 className="text-4xl md:text-5xl font-bold text-[#6B4828] drop-shadow mb-2">
                        Benvenuti all'Hotel Excelsior
                    </h1>
                    <p className="text-xl italic text-[#6B4828] drop-shadow mb-3">
                        Il tuo rifugio sul mare nelle Marche
                    </p>
                    <p className="text-[#6B4828] text-base md:text-lg drop-shadow mb-6">
                        Contattaci per prenotare il tuo soggiorno ideale a Pesaro.
                    </p>
                    <button
                        onClick={() => document.getElementById('contact-form')?.scrollIntoView({ behavior: 'smooth' })}
                        className="border border-[#6B4828] text-[#6B4828] bg-white/40 backdrop-blur-sm px-6 py-2 rounded hover:bg-[#6B4828] hover:text-white transition font-medium"
                    >
                        Contattaci
                    </button>
                </div>
                ...
                >
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
                        ...
                        <div>
                            <h2 className="text-lg font-bold text-[#6B4828] mb-5">Informazioni</h2>
                        ...
                        {/* ── Colonna destra: Form ── */}
                        <div id="contact-form">
                            <h2 className="text-lg font-bold text-[#6B4828] mb-5">Inviaci un messaggio</h2>
                            ...
                            {submitted ? (
                                <div className="text-center py-10">
                                    ...
                                    <button
                                        ...
                                        className="mt-5 text-[#6B4828] underline text-sm hover:opacity-70 transition"
                                    >
                                ...
                                <form onSubmit={handleSubmit} className="space-y-4">
                                    ...
                                    >
                                        ...
                                        >
                                            ...
                                            />
                                            <path
                                                d="M0,18 C50,6 100,24 150,18 C200,6 250,24 300,18 C350,6 400,24 400,18 L400,24 L0,24 Z"
                                                fill="white"
                                                opacity="0.5"
                                            />
                                        </svg>
